                ...
                <div class="card-body">
                    <form action="/product/edit/{{ $data->id }}" method="POST">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="harga" name="harga" min="1" value="{{ $data->harga }}">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kategori" id="inlineRadio1"
                                        value="Hewan Ternak" @if($data->kategori == 'Hewan Ternak') checked @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kategori" id="inlineRadio2"
                                        value="Produk Ternak" @if($data->kategori == 'Produk Ternak') checked @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kategori" id="inlineRadio3"
                                        value="Pakan Ternak" @if($data->kategori == 'Pakan Ternak') checked @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kategori" id="inlineRadio4"
                                        value="Lainnya" @if($data->kategori == 'Lainnya') checked @endif>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3">{{ $data->nama }}</textarea>
                            </div>
                        </div>
