...
<form action="{{ route('produk')}}" method='GET'>
    <div class="container" style=""><br><br><br>
        ...
        <div class="custom-inpForm text-center">
            <input type="text" class="form-control form-control-lg" name="search" id="exampleFormControlInput1"
                placeholder="Search">
...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="card mb-6" style="max-width: 100%; border-radius: 20px; margin-top: 12px">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="{{ URL::asset('storage/'.$x->image)}}" class="img-fluid rounded-start" width="300"
                        height="300" style="width: 300px; height: 170px;" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="{{ route('produk.show', $x->id) }}"
                                style="text-decoration: none; font-weight: 450; font-size: 18px;">Lihat Produk ></a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('produk')}}" method='GET'>
                <div class="modal-body text-start">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="filter" value="Hewan Ternak"
                            id="HewanTernak">
                        <label class="form-check-label" for="HewanTernak">Hewan Ternak</label>
                    </div>

                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="filter" value="Produk Ternak"
                            id="ProdukTernak">
                        <label class="form-check-label" for="ProdukTernak">Produk Ternak</label>
                    </div>

                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="filter" value="Pakan Ternak"
                            id="PakanTernak">
