<div class="col col-lg-2">
    <div class="card mb-3 border border-light">
        <ul class="list-group list-group-flush">
            ...
            <a href="{{ route('vendor.journal.index') }}" class="{{ Request::is('dashboard/vendor/journal*') ? 'border-start border-5 border-primary text-decoration-none' : 'text-decoration-none' }} "><li class="list-group-item sidebar-hover">
                <span><i class="bi bi-receipt-cutoff"></i></span>&nbsp;&nbsp;{{ __('JurnalKu') }}</li></a>

            <a href="{{ route('vendor.blog.index') }}" class="{{ Request::is('dashboard/vendor/blog*') ? 'border-start border-5 border-primary text-decoration-none' : 'text-decoration-none' }} "><li class="list-group-item sidebar-hover">
                <span><i class="bi bi-chat-square-text"></i></span>&nbsp;&nbsp;{{ __('BlogKu') }}</li></a>

            <a href="" class="text-decoration-none"><li class="list-group-item sidebar-hover">
                <span><i class="bi bi-person"></i></span>&nbsp;&nbsp;{{ __('ProfilKu') }}</li></a>
