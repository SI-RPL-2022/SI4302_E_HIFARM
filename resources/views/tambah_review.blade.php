    ...
    <form action="{{ route('review.store', $vendor_id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    <textarea class="form-control textarea-custom" name='review' id="exampleFormControlTextarea1"
                        rows="5" placeholder="Bagaimana tanggapan anda mengenai toko kami?"></textarea>
                </div><br>
