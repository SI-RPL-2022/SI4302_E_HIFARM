...
<html lang="en">
	...
	<link rel="stylesheet" href="css/style_lihatReview.css">
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-md-8 col-custom-flex">
									<img src="assets/discord3.png" class="img-user">
							    	<div class="mt-3">
										<h4>Brian Siluman</h4>
									</div>
								</div>
							...
							<div class="row mb-3">
								<div class="review">
									<label>Tokoh ini merespon dengan sangat baik, serta menyediakan produk-produk yang berkualitas</label>
								</div>
							</div>
