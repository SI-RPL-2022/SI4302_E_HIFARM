				...
				<div class="col-md-10 offset-md-1 ">
					<div class="row">
						<div class="col-md-8">
							...
							<div class="col-md-4">
							<form action="{{ route('thread.create')}}" method='GET'>
								<div class="d-grid">
									
									<button type="submit" class="btn btn-outline-primary"><b>+ Tambah Diskusi</b></button>
				...
				<div class="col-md-8 offset-md-2">
					<div class="row">
						...
						<div class="col-md-8 col-custom-flex">
							...
							<a style="text-decoration: none; --hover-color: blue" href="{{ url('thread/show/'.$thread->id) }}">
								<div class="mb-3" >
